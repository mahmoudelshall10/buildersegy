...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{secure_asset('images/bspyl.png')}}" type="image/x-icon">
    @else
    <link rel="shortcut icon" href="{{secure_asset('images/builders_5.png')}}" type="image/x-icon">
    @endif
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        ...
        <a class="navbar-brand" href="{{ secure_asset('index')}}">
        @if(Request::segment(1) == 'bspyl-home' || Request::segment(1) == 'bspyl-about' || Request::segment(1) == 'bspyl-stages' ||Request::segment(1) == 'bspyl-form' )
        <img src='{{secure_asset('images/bspyl.png')}}' style="height:50px;">
        @else
        <img src='{{secure_asset('images/builders_5.png')}}' height='100px'>
        @endif
        </a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="{{ Request::segment(1) === 'index' ? 'nav-item active' : 'nav-item' }}"><a href="{{ secure_asset('index')}}" class="nav-link">Home</a></li>

            <li class="{{ Request::segment(1) === 'about' ? 'nav-item active' : 'nav-item' }}"><a href="{{ secure_asset('about') }}" class="nav-link">About Us</a></li>
            ...
            <li class="{{ Request::segment(1) === 'builders-story' ? 'nav-item active' : 'nav-item' }}"><a href="{{ secure_asset('builders-story') }}" class="nav-link">Builders Story</a></li>

            <li class="{{ Request::segment(1) === 'contact' ? 'nav-item active' : 'nav-item' }}"><a href="{{ secure_asset('contact') }}" class="nav-link">Contact</a></li>
            
            <li><a class="btn btn-danger" href='{{ secure_asset('bspyl-home') }}' role="button" class="nav-link" style="margin-top: 8px;">Join BSPYL</a></li>
          </ul>
        </div>
    ...
    @if(Request::segment(1) != 'index' )
      ...
      <section class="hero-wrap hero-wrap-2" style="background-image: url({{ secure_asset('images/contact_us.jpg') }} );" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      @elseif(Request::segment(1) == 'builders-story-single')
      <section class="hero-wrap hero-wrap-2" style="background-image: url( {{ secure_asset('images/business_3.jpg') }} );" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      ...
      <section class="hero-wrap hero-wrap-2" style="background-image: url( {{ secure_asset('images/image_4.jpg') }} );" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      @else

      <section class="hero-wrap hero-wrap-2" style="background-image: url( {{secure_asset('images/business.jpg')}} );" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      @endif
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-end justify-content-center">
            ...
            <div class="col-md-9 ftco-animate pb-5 text-center">
              ...
              <p class="breadcrumbs"><span class="mr-2"><a href="{{ secure_asset('index')}}">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>
                @if(Request::segment(1) === 'about')
                About Us
                @elseif(Request::segment(1) === 'consultancy')
                Consultancy
  ...
  @else
  <div class="hero-wrap js-fullheight" style="background-image: url({{secure_asset('images/consultation.jpg')}});" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
