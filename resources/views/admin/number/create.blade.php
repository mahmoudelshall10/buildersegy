        ...
        <div class="row">
                ...
                <div class="box box-primary">
                        ...
                        <div class="box-header">
                          <h3 class="box-title">Form For Numbers</h3>
                        </div><!-- /.box-header -->
                        {{-- {!!Form::open(["url"=>"admin/numbers","method"=>"POST","class"=>"form-horizontal","files"=>"true"])!!} --}}
                       
                        <!-- form start -->
                        <form role="form" action="{{url('/admin/numbers')}}" enctype="multipart/form-data" method="POST">
                            {{ csrf_field() }}
                          <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  value="{{ old('fldNumber') }}" name='fldNumber' required placeholder="Number">
                                </div>
