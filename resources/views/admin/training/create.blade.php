    ...
    <section class="content">
        ...
        <div class="row">
                ...
                <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="{{url('/admin/trainings')}}" enctype="multipart/form-data" method="POST">
                            {{ csrf_field() }}
                          <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  value="{{ old('fldDuration') }}" name='fldDuration' required placeholder="Duration">
                                </div>
